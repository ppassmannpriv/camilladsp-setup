export class MockCamillaDSP {
    ...
    private numInputs = 8;
    private numOutputs = 8;
    private mutes: boolean[] = Array(16).fill(false);
    private config = {
        pipeline: [
    ...
    private configs = ["default.yml", "night.yml", "testing.yml"];
    private captureDevice = "USB Audio Class 2.0";
    private playbackDevice = "ALSA: hw:PCH,0";
